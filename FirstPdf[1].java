...
public class FirstPdf {
                private static String FILE = "c:/Users/David/desktop/TestPdf.pdf";
        ...
        private static void addTitlePage(Document document)
                ...
                preface.add(new Paragraph(
                                "This document is a preliminary version and not subject to your license agreement or any other agreement with ESC ;-).",
                                redFont));
...
//                subCatPart.add(new Paragraph("Paragraph 3"));
                ...
                // add a table
                createTable(subCatPart, yName, maxx, minx, avg, mode, median);
        ...
        public  void createTable(Section subCatPart,String yName, double maxx,double minx, double avg, double mode, double median)
                ...
                PdfPCell c1 = new PdfPCell(new Phrase("Events"));
                ...
                table.addCell(String.valueOf(mode));
              
                subCatPart.add(table);

        }
        double minx, maxx , temp ;
